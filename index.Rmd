...
## Reading  training data from web.
...
5. Althougth Random forest may overfit a training data set, nevetheless, it has been shown that classifier variance does not grow with the number of trees used. 
...
In the  following figures Fig1 and Fig2, we have created two representation of the top 10 variables categorized by importance. Fig1 display the top 10 predictors Importance accuracy  and Fig 2 display the top 10 predictors Gini Importance.
